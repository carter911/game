...
class Banner extends AdminBase
{
    ...
    public function __construct()
    {
        parent::__construct();
        $this->table = "f_banner";
        $this->indexUrl="/admin/banner/get_list";
        $this->updateUrl="/admin/banner/store";
        $this->addUrl="/admin/banner/save";
        $this->delUrl="/admin/banner/del";
        $this->router="/admin/banner/index";
//        $this->relationTable = [
//            [
//                'merchant m',
